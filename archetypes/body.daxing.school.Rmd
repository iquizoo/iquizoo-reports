...
本校共施测`r n_cls`个班级。表\@ref(tab:<<ab_id>>-tab)中展示了本区、本校和各班的学生整体表现情况。`r extra_tab`。按照学生总体表现划分ABCD四个水平：其中，**水平A**为优秀，代表总体水平的90%及以上；**水平B**为良好，代表总体水平的70%至90%；**水平C**为中等，代表总体水平的30%至70%；**水平D**为较差，代表总体水平的0%至30%。
