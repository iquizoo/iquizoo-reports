...
scores_combined_this_ability %>%
  ...
  geom_vline(xintercept = mean(scores_unit_this_ability$score, na.rm = TRUE), color = "red") +
...
本校学生总体的`r ab_name_cn`测评的得分分布见图\@ref(fig:<<ab_id>>-histogram)，其中红色竖线表示本校学生的平均得分。本校学生的整体表现`r diff_msg`。
...
本校共施测`r n_cls`个班级。表\@ref(tab:<<ab_id>>-tab)中展示了本区、本校和各班的学生整体表现情况。`r extra_tab`。按照学生总体表现划分ABCD四个水平：其中，**水平A**为优秀，代表总体水平的90%及以上；**水平B**为良好，代表总体水平的70%至90%；**水平C**为中等，代表总体水平的30%至70%；**水平D**为较差，代表总体水平的0%至30%。
...
本校学生总体在`r ab_name_cn`测评中各个水平的人数比例如图\@ref(fig:<<ab_id>>-grading)。每个班级的学生从等级优秀到不足的占比情况存在差异，应该重点关注在等级D中占比较大的班级对学生的`r ab_name_cn`进行有计划的训练和干预。按照学生总体表现划分ABCD四个水平：其中，**水平A**为优秀，代表总体水平的90%及以上；**水平B**为良好，代表总体水平的70%至90%；**水平C**为中等，代表总体水平的30%至70%；**水平D**为较差，代表总体水平的0%至30%。
