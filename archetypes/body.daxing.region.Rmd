...
本区共施测`r n_distinct(scores_region$school)`所学校，其中学校名称用编码代替。表\@ref(tab:<<ab_id>>-tab)中展示了本区及各学校的学生整体表现情况。从学生的平均水平来看，`r best_avg`的学生表现最好，而`r worst_avg`的学生表现最差，`r diff_msg_avg`。其中，**水平A**：优秀；**水平B**：良好；**水平C**：中等；**水平D**：较差。
...
各个学校学生总体在`r ab_name_cn`测评中各个水平的人数比例如图\@ref(fig:<<ab_id>>-grading)所示。每个学校的学生从等级优秀到不足的占比情况存在差异，应该重点关注在等级D中占比较大的学校，对该校学生的`r ab_name_cn`进行有计划的训练和干预。其中，**水平A**：优秀；**水平B**：良好；**水平C**：中等；**水平D**：较差。
